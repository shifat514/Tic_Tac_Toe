...
function selectGameField(event){
    ...
    const selectedColumn= selectedField.dataset.col-1; //strings converts to integer because of minus
    ...
    gameData[selectedRow][selectedColumn] = activePlayer+1; //first value row second value column
...
// for diagonal comparison top left to bottom right
...
function endGame(winnerId){
    ...
    // the slash is need to show js that its not an end to the string 
    }
}
